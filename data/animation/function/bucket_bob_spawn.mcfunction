summon minecraft:salmon ~ ~ ~ {CustomName:'{"text":"bob"}',PersistenceRequired:1b,CanPickUpLoot:0b,Health:10,Attributes:[{Name:"generic.max_health",Base:10}],Health:10,ActiveEffects:[{Id:14,Amplifier:0,Duration:2147483647}],Tags:["bob","unscanned","bucket"]}
