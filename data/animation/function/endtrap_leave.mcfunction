...
execute if predicate animation:endtrap_build run advancement grant @s only animation:build_infrastructure_endtrap
...
advancement grant @s only animation:leave_endtrap