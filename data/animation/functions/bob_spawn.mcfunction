...
summon armor_stand ~ ~ ~ {Invisible:1b,Invulnerable:1b,Marker:1b,NoBasePlate:1b,Tags:["bob_face","unscanned"],ArmorItems:[{},{},{},{id:"prismarine_crystals",Count:1b,tag:{CustomModelData:1}}],HandItems:[{},{}]}
