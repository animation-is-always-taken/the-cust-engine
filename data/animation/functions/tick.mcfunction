...
#execute as @a[nbt={Inventory:[{Slot:103b,id:"minecraft:leather_helmet",tag:{display:{color:2}}},{Slot:102b,id:"minecraft:leather_chestplate",tag:{display:{color:2}}},{Slot:101b,id:"minecraft:leather_leggings",tag:{display:{color:2}}},{Slot:100b,id:"minecraft:leather_boots",tag:{display:{color:2}}}]}] run function animation:buzo
#execute as @a[nbt={Inventory:[{Slot:103b,id:"minecraft:chainmail_helmet",tag:{Trim:{pattern:"minecraft:buzo"}}},{Slot:102b,id:"minecraft:chainmail_chestplate",tag:{Trim:{pattern:"minecraft:buzo"}}},{Slot:101b,id:"minecraft:chainmail_leggings",tag:{Trim:{pattern:"minecraft:buzo"}}},{Slot:100b,id:"minecraft:chainmail_boots",tag:{Trim:{pattern:"minecraft:buzo"}}}]}] run function animation:buzo
#execute as @a[nbt={Inventory:[{id:"minecraft:prismarine_shard",tag:{CustomModelData:2}}]}] run title @s actionbar ["",{"text":"[","color":"aqua"},{"score":{"name":"@s","objective":"chunkX"},"color":"aqua"},{"text":",","color":"aqua"},{"score":{"name":"@s","objective":"chunkZ"},"color":"aqua"},{"text":"]","color":"aqua"}]
