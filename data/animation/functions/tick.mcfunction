...
#endtraps y coso rng
execute at @e[type=minecraft:armor_stand,tag=endtrap] run execute as @e[distance=..1,tag=!endtrap] run function animation:endtrap_enter
...
execute as @e[tag=end_mail,predicate=animation:in_end] run function animation:endtrap_enter1
